    ...
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-black dark:text-white tracking-tight flex items-center gap-2">
          <Clock className="w-7 h-7 text-indigo-600 dark:text-indigo-400" /> Leave Balance & Quota Breakdown
        </h1>
        ...
        {statCards.map((card, idx) => (
          <div key={idx} className="glass-card rounded-2xl p-5 flex flex-col justify-between">
            <div>
              ...
              <p className="text-2xl font-extrabold text-black dark:text-white mt-2 font-mono">{card.value}</p>
            </div>
