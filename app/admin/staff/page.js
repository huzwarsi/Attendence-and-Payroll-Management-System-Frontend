    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Manage employee profiles, shift schedules, salary formulas, and leave quotas.</p>
        </div>
      ...
      <div className="glass-card rounded-2xl p-4 flex flex-col sm:flex-row gap-3 items-center justify-between">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <div className="relative w-full sm:w-48">
            ...
            <select
              ...
              className="w-full bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-700 rounded-xl pl-9 pr-4 py-2 text-xs text-black dark:text-white font-medium focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 appearance-none transition-all"
            >
      ...
      <div className="glass-card rounded-2xl overflow-hidden">
        <div className="overflow-x-auto custom-scrollbar">
          <table className="w-full text-left text-xs min-w-[850px]">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/50 text-slate-900 dark:text-slate-200">
              {loading ? (
                <tr>
                  <td colSpan="8" className="py-8 text-center text-slate-400">Loading staff records...</td>
                </tr>
              ) : staffList.length === 0 ? (
                <tr>
                  <td colSpan="8" className="py-8 text-center text-slate-400">No staff members found matching criteria.</td>
                </tr>
              ) : (
                staffList.map((s) => (
                  <tr key={s.id} className="hover:bg-blue-500/[0.02] dark:hover:bg-blue-500/[0.04] transition-colors">
                    <td className="py-3 px-4">
                      <div>
                        <p className="font-bold text-black dark:text-white text-sm">{s.full_name}</p>
                        <p className="text-[11px] font-mono text-slate-400">CNIC: {s.cnic}</p>
                      </div>
                    </td>
                    <td className="py-3 px-4 font-semibold text-slate-700 dark:text-slate-300">{s.designation}</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-300 font-medium">
                      <p>{s.email}</p>
                      <p className="text-[11px] text-slate-400">{s.phone}</p>
                    </td>
                    <td className="py-3 px-4">
                      <span className="inline-flex items-center gap-1 font-mono text-[11px] font-bold bg-blue-500/10 text-blue-600 dark:text-blue-400 px-2 py-1 rounded-lg border border-blue-500/15">
                    ...
                    <td className="py-3 px-4">
                      {s.is_active ? (
                        <span className="badge badge-present inline-flex items-center gap-1">
                          <CheckCircle2 className="w-3 h-3" /> Active
                        </span>
                      ) : (
                        <span className="badge badge-absent inline-flex items-center gap-1">
                    ...
                    <td className="py-3 px-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="p-1.5 bg-slate-100 dark:bg-slate-800/60 hover:bg-blue-50 dark:hover:bg-blue-500/10 text-blue-600 dark:text-blue-400 rounded-lg transition-colors"
                          title="Edit Staff"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 bg-slate-100 dark:bg-slate-800/60 hover:bg-rose-50 dark:hover:bg-rose-500/10 text-rose-600 dark:text-rose-400 rounded-lg transition-colors"
                          title="Delete Staff"
                        >
        ...
        {/* Pagination Footer */}
        <div className="p-4 border-t border-slate-200/60 dark:border-slate-800/60 flex items-center justify-between text-xs font-semibold text-slate-500 dark:text-slate-400">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 bg-white/80 dark:bg-slate-800/80 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 disabled:opacity-50 text-black dark:text-white rounded-lg transition-all font-bold"
            >
              Previous
            </button>
            <button
